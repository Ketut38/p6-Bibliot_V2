...
<ul>
    ...
    <li>Date du début de l'emprunt: <b><fmt:formatDate value="${borrow.startBorrowDate}" pattern="dd-MM-yyyy"/></b></li>
    <li>Date de fin: <b><fmt:formatDate value="${borrow.endBorrowDate}" pattern="dd-MM-yyyy"/> </b></li>
