 ...
 * 
 */
@WebServiceClient(name = "bookWeb", targetNamespace = "http://webservices.p3.occ.org/", wsdlLocation = "http://lfr011641:8080/web-service-06328874639902306617.0.1-SNAPSHOT/ws/BookWs?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKWEB_QNAME = new QName("http://webservices.p3.occ.org/", "bookWeb");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://lfr011641:8080/web-service-06328874639902306617.0.1-SNAPSHOT/ws/BookWs?wsdl");
    ...
    public BookWs getBookWsPort() {
        return super.getPort(new QName("http://webservices.p3.occ.org/", "bookWsPort"), BookWs.class);
    }
    ...
    public BookWs getBookWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.p3.occ.org/", "bookWsPort"), BookWs.class, features);
    }
