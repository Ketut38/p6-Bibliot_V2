 ...
 * 
 */
@WebServiceClient(name = "borrowWeb", targetNamespace = "http://webservices.p3.occ.org/", wsdlLocation = "http://lfr011641:8080/web-service-07442684945879092018.0.1-SNAPSHOT/ws/borrowWs?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://lfr011641:8080/web-service-07442684945879092018.0.1-SNAPSHOT/ws/borrowWs?wsdl");
