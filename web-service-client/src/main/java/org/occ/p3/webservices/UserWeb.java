 ...
 * 
 */
@WebServiceClient(name = "userWeb", targetNamespace = "http://webservices.p3.occ.org/", wsdlLocation = "http://lfr011641:8080/web-service-05227549248861136051.0.1-SNAPSHOT/ws/UserWs?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWEB_QNAME = new QName("http://webservices.p3.occ.org/", "userWeb");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://lfr011641:8080/web-service-05227549248861136051.0.1-SNAPSHOT/ws/UserWs?wsdl");
    ...
    public UserWs getUserWsPort() {
        return super.getPort(new QName("http://webservices.p3.occ.org/", "userWsPort"), UserWs.class);
    }
    ...
    public UserWs getUserWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.p3.occ.org/", "userWsPort"), UserWs.class, features);
    }
